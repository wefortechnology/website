...
function getTechIcon(name: string) {
  switch (name) {
    case "Next.js":
      return <SiNextdotjs className="w-5 h-5 text-white shrink-0" />;
    case "React":
...
export default function Home() {
  ...
  return (
    <PageTransition>
      ...
      {/* Trust & Stats Section */}
      <section className="py-12 bg-white/5 border-y border-white/5 relative z-10 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 mb-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 text-center">
            {stats.map((stat, i) => (
              <div
                key={i}
                className="flex flex-col gap-1.5 p-4 sm:p-6 rounded-2xl bg-white/[0.02] border border-white/5 shadow-inner"
              >
                <span className="text-2xl sm:text-4xl md:text-5xl font-black text-white font-mono">
                  <AnimatedCounter value={stat.value} suffix={stat.suffix} />
                </span>
                <span className="text-[11px] sm:text-sm font-light text-slate-400">
                  {stat.label}
                </span>
              </div>
            ))}
        ...
        {/* Tech Marquee */}
        <div className="relative w-full border-t border-white/5 pt-8 overflow-hidden select-none flex">
          <div className="animate-marquee gap-6 whitespace-nowrap pr-6 flex items-center">
            {marqueeItems.map((item, idx) => (
              <div
                key={idx}
                className="flex items-center gap-3 bg-white/[0.03] border border-white/5 px-5 py-2.5 rounded-2xl hover:bg-white/[0.08] hover:border-accent-blue/30 transition-all duration-300"
              >
                {getTechIcon(item)}
            ...
            <div className="lg:col-span-6 space-y-6">
              <div>
                <motion.span
                  ...
                  className="text-xs font-semibold uppercase tracking-widest text-accent-blue bg-accent-blue/10 px-3 py-1 rounded-full border border-accent-blue/20 w-fit mb-4 inline-block"
                >
            ...
            <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
              {values.map((val) => {
                ...
                return (
                  <div
                    key={val.name}
                    className="glow-card rounded-xl p-6 border border-white/5 flex flex-col gap-4"
                  >
                    <div className="w-10 h-10 rounded-lg bg-accent-blue/15 border border-accent-blue/20 text-accent-blue flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:items-start items-start">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="flex flex-col gap-4 border-t border-white/5 pt-6">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium text-white">Full-Stack Capability</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle2 className="w-5 h-5 text-accent-blue" />
                  <span className="text-sm font-medium text-white">Zoho Certified Methodologies</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle2 className="w-5 h-5 text-accent-blue" />
                  <span className="text-sm font-medium text-white">Enterprise Security Architecture</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
              {whyChooseUs.map((item, idx) => (
                <div
                  key={idx}
                  className="glow-card rounded-xl p-5 border border-white/5 flex gap-4 hover:border-accent-blue/30"
                >
                  <div className="w-8 h-8 rounded-full bg-accent-blue/10 flex items-center justify-center text-accent-blue font-mono font-bold text-xs select-none shrink-0 mt-0.5">
                    {idx + 1}
                  </div>
                  <div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:items-stretch items-start mt-12">
            ...
            <div className="lg:col-span-5 h-full">
              <div className="glow-card rounded-2xl p-6 sm:p-10 border border-white/5 bg-dark-card/30 h-full flex flex-col justify-between">
                <div className="space-y-8">
                  <div>
                    <span className="text-xs font-semibold uppercase tracking-widest text-accent-blue bg-accent-blue/10 px-3 py-1 rounded-full border border-accent-blue/20 w-fit mb-4 inline-block">
                      Contact Channels
                    </span>
                    <h3 className="text-2xl font-bold text-white mb-2 tracking-tight">Direct Communication</h3>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex gap-4 items-start">
                      <div className="p-3 rounded-lg bg-accent-blue/15 text-accent-blue h-fit">
                        <MapPin className="w-5 h-5" />
                      </div>
                      <div>
                        <h4 className="text-sm font-bold text-white mb-1">Our Office</h4>
                    ...
                    <div className="flex gap-4 items-start">
                      ...
                      <div>
                        <a href="mailto:wefortechnology.ai@gmail.com" className="text-xs text-slate-400 font-light font-mono hover:text-white transition-colors">
                    ...
                    {/* Hours Detail */}
                    <div className="flex gap-4 items-start">
                      <div className="p-3 rounded-lg bg-accent-cyan/15 text-accent-cyan h-fit">
                        <Clock className="w-5 h-5" />
                      </div>
                      <div>
                        <h4 className="text-sm font-bold text-white mb-1">Business Hours</h4>
                        <p className="text-xs text-slate-400 font-light leading-relaxed">
                ...
                <div className="pt-6 border-t border-white/5 mt-8">
                  ...
                  <div className="flex gap-3">
                    <a
                      ...
                      aria-label="LinkedIn"
                      className="p-2.5 rounded-lg bg-white/5 border border-white/5 text-slate-400 hover:text-accent-blue hover:border-accent-blue/30 transition-all duration-300"
                    >
